...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='actor',
            name='country',
            field=models.CharField(max_length=20, verbose_name='Страна рождения'),
        ),
        migrations.AlterField(
            model_name='actor',
            name='fname',
        ...
        migrations.AlterField(
            model_name='country',
            name='name',
            field=models.CharField(max_length=20, verbose_name='Страна где снимался фильм'),
        ),
        migrations.AlterField(
            model_name='director',
            name='fname',
        ...
        migrations.AlterField(
            model_name='kino',
            name='actor',
            field=models.ManyToManyField(to='catalog.actor', verbose_name='Актёры'),
        ),
        migrations.AlterField(
            model_name='kino',
            name='rating',
